    ...
    <main className={styles.main}>
      ...
      <div className={styles.grid}>
        ...
        >
          ...
          <Image src="/project1.jpg" alt="test" width={131} height={106}/>
          <Image src="/project2.jpg" alt="test" width={131} height={106}/>
          <Image src="/project3.jpg" alt="test" width={131} height={106}/>
        </a>
